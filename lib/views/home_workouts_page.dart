...
class HomeWorkoutsPage extends StatefulWidget {
  @override
  _HomeWorkoutsPageState createState() => _HomeWorkoutsPageState();
}

class _HomeWorkoutsPageState extends State<HomeWorkoutsPage> {
  ...
  _fetchWorkouts() async {
    ...
    for (int i = 0; i < _apiResponse.data!.length; i++) {
      if (!videoID.contains(_apiResponse.data![i].workoutVideo) &&
          _apiResponse.data![i].workoutType == 1) {
